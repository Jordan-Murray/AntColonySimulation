...
class SimObjectManager{
  ...
  void removeAllObjectsWithTag(String _tag){
    for (int i = simObjList.size() - 1; i >= 0; i--) {
        SimTransform object = simObjList.get(i);
  ...
  ArrayList<SimTransform> getAllObjectsWithTag(String _tag){
  ...
  ArrayList<SimTransform> getSimObjectsWithColliderId(String _colliderId){
